...
if (!empty($_POST)) {
    ...
    $stmt = $pdo->prepare('INSERT INTO langue VALUES (?, ?)');
    $stmt->execute([$nomLangue, $niveau]);
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label">
                                            ...
                                            <input name="nomLangue" id="nomLangue" type="text" class="form-control resume" placeholder="ma langue">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group app-label">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center">
                                            <input type="submit" id="submit" name="send" class="submitBnt btn btn-secondary mt-5" value="Create langue">
                                        </div>
                                    </div>
                                </div>
                            </form>
