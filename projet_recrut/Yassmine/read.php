...
$stmt = $pdo->prepare('SELECT * FROM utilisateur ORDER BY iduser LIMIT :current_page, :record_per_page');
                ...
                <tbody>
                    <tr>
                        <?php foreach ($users as $user): ?>
                            ...
                            <td><?=$user['login']?></td>
                            <td class="actions">
                                <a href="update.php?iduser=<?=$user['iduser']?>" class="edit" style="padding: 20px;"><i class="bi bi-pencil-fill"></i></a>
                                <a href="delete.php?iduser=<?=$user['iduser']?>" class="trash" style="padding: 20px;"><i class="bi bi-trash"></i></a>
                            </td>
                        <?php endforeach; ?>
                    </tr>
                </tbody>
